...
const buttonVariants = cva(
	'md:h-10 md:py-[10px] md:px-[18px] md:rounded-[60px] inline-flex items-center justify-center gap-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-main_darker focus-visible:ring-offset-2 disabled:pointer-events-none font-bold',
	{
		variants: {
			variant: {
